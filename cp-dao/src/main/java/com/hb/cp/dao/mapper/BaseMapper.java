...
public interface BaseMapper {
     ...
     * @return 插入的条数
     */
    int insertSelective(@Param("sqlStatement") String sqlStatement, @Param("params") Map<String, Object> params);
     ...
     * @return 更新的条数
     */
    int updateSelectiveByPrimaryKey(@Param("sqlStatement") String sqlStatement, @Param("cloumns") Map<String, Object> cloumns, @Param("params") Map<String, Object> params);
